<?php namespace App\Http\Controllers;
	...
	class AdminProductCategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Category Type","name"=>"category_type"];
			...
			$this->form[] = ['label'=>'Category Type','name'=>'category_type','type'=>'select','validation'=>'required','width'=>'col-sm-10','dataenum'=>'RMPM;Non RMPM'];
